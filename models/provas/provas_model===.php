...
//                );
   ...
   //     echo $sql;exit;
    ...
    function lista_provas(){
        $sql = "SELECT P.CD_PROVA,P.NUM_PROVA,P.PERIODO,P.DT_PROVA,P.QTDE_QUESTOES,P.TITULO,P.CD_PROFESSOR,NVL(P.CD_STATUS,1) CD_STATUS,
                    C.NM_CURSO,
            ...
            --    INNER JOIN BD_SICA.AVAL_PROVA_STATUS S ON S.CD_STATUS = P.CD_STATUS
    ...
    function confirmar_edicao($param){
        //EDITA A QUESTAO
        $sql = "UPDATE BD_ACADEMICO.AVAL_QUESTAO SET 
                    CD_CURSO = ".$param['curso'].", ORDEM_SERIE = ".$param['serie'].", CD_DISCIPLINA = ".$param['disc'].", 
                    NR_DIFICULDADE = ".$param['dificuldade'].", FLG_TIPO = '".$param['tipo']."', DC_QUESTAO = '".$param['pergunta']."',
