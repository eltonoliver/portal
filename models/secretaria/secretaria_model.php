...
//        );
     //   return $this->db->sp_seculo('BD_RH', 'SP_COL_RELAT_HORARIO_ALUNO', $params);
        
        $params = array(
            array('name' => ':P_CD_ALUNO', 'value' => $parametro['aluno']),
            array('name' => ':P_PERIODO', 'value' => $parametro['periodo']),
            array('name' => ':P_RC1', 'value' => $cursor, 'type' => OCI_B_CURSOR)
        );
        return $this->db->sp_seculo('BD_SICA', 'AES_RELAT_HORARIO_ALUNO', $params);
    ...
    function atividade($parametro) {
        ...
        return $this->db->sp_seculo('BD_RH', 'SP_COL_RELAT_HORARIO_ATIVIDADE', $params);
    }
    ...
    function aluno($dado) {
        ...
        return $this->db->sp_seculo('BD_PORTAL', 'AES_ALUNO_MATRICULADO', $params);
    }
    ...
    function boletim($dado) {
        ...
        return $this->db->sp_seculo('BD_SICA', 'AES_BOLETIM_COLEGIO', $params);
    }
    ...
    function plano_ensino($dado) {
        ...
        return $this->db->sp_seculo('BD_PORTAL', 'AES_PLANO_ENSINO', $params);
    }
    ...
    function objeto($dado) {
        ...
        return $this->db->sp_seculo('BD_SICA', 'AES_OBJETOS_DISPONIVEIS', $params);
    }
    ...
    function declaracao($dado) {
        ...
        return $this->db->sp_seculo('BD_SICA', 'AES_DOCUMENTO', $params);
    }
    ...
    /*Método responsável por listar cursos*/
    function lista_curso(){

        return $this->db->query("SELECT CD_CURSO,NM_CURSO_RED FROM bd_sica.cursos WHERE CD_CURSO <> 19 ORDER BY NM_CURSO_RED")->result();
    }
