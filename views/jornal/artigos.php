                ...
                <table width="100%" border="0" cellspacing="0"  cellpadding="0" class="table table-striped table-bordered table-hover" id="data-table" aria-describedby="data-table_info">
                            ...
                            <tbody>
                                ...
                                if (count($listar) > 0) { 
                                    foreach ($listar as $row) { 
                                        ...
                                        <tr>
                                            ...
                                            <?php if($row['PUBLICADO']==1){ ?>
                                                <a href="<?=SCL_JOR?>index.php/artigos/artigo_detalhe?id=<?=$row['CD_ARTIGO']?>" title="Clique aqui para visualizar a notícia" target="_blank"><?= $row['TITULO']?></a>
                                    ...
                                    <tr>
                                        <td colspan="8" align="center"><strong>NÃO HÁ ARTIGOS CADASTRADO</strong></td>
                                    </tr>
                                    <tr>
