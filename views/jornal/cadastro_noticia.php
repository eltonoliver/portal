...
?>
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <form action="<?= SCL_RAIZ ?>jornal/noticias/registar_infor" method="post"  name="formArtigo" id="formArtigo" enctype='multipart/form-data'>
                        ...
                        <input name="codigo" type="hidden" id="codigo" value="<?= $codigo ?>" />
                                ...
                                if ($this->session->userdata('SCL_SSS_USU_TIPO') == 30) {
                                    ...
                                    echo form_hidden('cd_autor', $this->session->userdata('SCL_SSS_USU_PESSOA'));
                                    echo form_input('autor', '' . $nome . '', 'class="form-control" readonly="readonly"');
                                }
                                echo br();
                                ...
                                echo br();
                                echo form_input('titulo', '' . $titulo_noticia . '', 'class="form-control"');
                                echo br();
                                ...
                                echo form_hidden('edt_arquivo', '' . $imagem . '');
                                echo br();
                        ...
                        <div class="panel-footer">
                            <div class="pull-left"><a href="<?= SCL_RAIZ ?>jornal/noticias/" class="btn btn-inverse"><i class="fa fa-backward"></i> Cancelar</a></div>
