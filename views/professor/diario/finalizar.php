<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header" data-target="#modal-step-contents">
     <h5 class="bigger lighter"> <i class="icon-table"></i> FINALIZAR AULA </h5>
    </div>
    ...
    <div class="modal-footer">
      <button class="btn btn-success btn-sm btn-next" onclick="document.forms['frmfrequencia'].submit();" href="javascript:void(0)"> Finalizar Aula <i class="icon-arrow-right icon-on-right"></i> </button>
