                                ...
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-list"></i></span>
                                    <select name="curso" id="curso" class="form-control" required="required">
                                        ...
                                        <? foreach ($curso as $item) { ?>
                                            <option <?php if($dados[0]['CD_CURSO'] == $item['CD_CURSO']){ echo 'selected="selected"'; } ?> value="<?= $item['CD_CURSO'] ?>">
                                                <?= $item['NM_CURSO'] ?>
                                            </option>
                                        <? } ?>
                                    </select>
                            ...
                            <div class="controls row">
                                ...
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-group"></i></span>
                                    <select name="serie" id="serie" class="form-control" required="required">
                                        ...
                                        if($acao == 'editar'){
                                        foreach ($serie as $s) { ?>
                                            <option <?php if($dados[0]['CD_SERIE'] == $s['ORDEM_SERIE']){ echo 'selected="selected"'; } ?> value="<?= $s['ORDEM_SERIE'] ?>">
                                                <?= $s['NM_SERIE'] ?>
                                            </option>
                                        <? }} ?>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls row">
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                    <input name="autor" type="text" class="form-control"  placeholder="Autor do Livro" id="autor" size="20"  value="<?=$dados[0]['AUTOR']?>">
                                </div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls row">
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-book"></i></span>
                                    <input name="ano_edicao" type="text" class="form-control"  placeholder="Ano de Edição" id="ano_edicao" size="20"  value="<?=$dados[0]['ANO_EDICAO']?>">
                                </div>
                            </div>
                        </div>
                    </td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls row">
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                                    <input name="editora" type="text" class="form-control"  placeholder="Editora do Livro" id="editora" size="20"  value="<?=$dados[0]['EDITORA']?>">
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td width="34%">
                        <div class="form-group">
                            ...
                            <div class="controls row">
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                                    <input name="nome" type="text" class="form-control" required="required" placeholder="Nome do Livro" id="nome" size="20"  value="<?=$dados[0]['LIVRO_TITULO']?>">
                                </div>
                            </div>
                        </div>
                    </td>
                                ...
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-book"></i></span>
                                    <select name="cd_disciplina" id="cd_disciplina" class="form-control" required="required">
                                        ...
                                        <? foreach ($disciplina as $item) { ?>
                                            <option <?php if($dados[0]['CD_DISCIPLINA'] == $item['CD_DISCIPLINA']){ echo 'selected="selected"'; } ?> value="<?= $item['CD_DISCIPLINA'] ?>">
                                                <?= $item['NM_DISCIPLINA'] ?>
                                            </option>
                                        <? } ?>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls row">
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-file"></i></span>
                                    <input name="cod_ref" type="text" class="form-control"  placeholder="Código Referencia" id="cod_ref" size="20"  value="<?=$dados[0]['CODIGO_REFERENCIA']?>">
                                </div>
                            </div>
                        </div>
                    </td>
                            ...
                            <div class="controls row">
                                <div class="input-group col-sm-10"> <span class="input-group-addon"><i class="fa fa-check"></i></span>
                                    <select name="ativo" id="ativo" class="form-control" required="required">
                                        <option <?php if($dados[0]['ATIVO'] == 1){ echo 'selected="selected"'; } ?>  value="1">Sim</option>
                                        <option <?php if($dados[0]['ATIVO'] == 2){ echo 'selected="selected"'; } ?>value="0">Não</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls row">
                                <div class="input-group col-sm-11"> <span class="input-group-addon"><i class="fa fa-text-width"></i></span>
                                    <input name="obs" type="text" class="form-control" placeholder="Observação" id="obs"  value="<?=$dados[0]['OBSERVACAO']?>">
                                </div>
                            </div>
                        </div>
                    </td> 
