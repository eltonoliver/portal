                                        ...
                                        foreach ($listar_aluno as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <input type="hidden"   name="nObj_<?= $row->CD_ALU_DISC ?>" id="cObj_<?= $row->CD_ALU_DISC ?>" value="<?php 
                                                ...
                                                <td align="center">
                                                    ...
                                                    elseif ($row->NOTA > 0) {
                                                        $valor = $row->NOTA;
                                                        //echo number_format(str_replace(',', '.', $valor), 1, '.', '');
                                                        echo '<input class="text-center" value="'.$row->NOTA.'"  name="nota_' . $row->CD_ALU_DISC . '" placeholder="00.0" type="number" id="nota_' . $row->CD_ALU_DISC . '" place size="3" min="0.1" max="10" step=".1"/>';
                                                    } elseif ($row->NOTA == '0') {
                                                        $valor = $row->NOTA;
                                                        echo number_format(str_replace(',', '.', $valor), 1, '.', '');
                                                        ...
                                                        $valor = '';
                                                        echo '<input name="nota_' . $row->CD_ALU_DISC . '" placeholder="00.0"  type="text" id="nota_' . $row->CD_ALU_DISC . '" place size="5" maxlength="5"   />';
                                                    }
                                                    ?>                                                    
                                                    <input name="CD_ALU_DISC" type="hidden" value="<?= $row->CD_ALU_DISC ?>" >
                                                </td>
