                            ...
                            <thead>
                                <tr style="background: gainsboro">
                                    <th class="text-center" colspan="4">
                                        ...
                                        <!--
                                        <a target="_blank" class="btn btn-default" href="https://seculomanaus.com.br/academico/108/prova_gabarito/avaliacao_online/?prova=<?= base64_encode($row['CD_PROVA']) ?>&aluno=<?= $token ?>">
                                            <i class="fa fa-print"></i> PROVA
                                        </a>
                                        -->
                                          <a target="_blank" class="btn btn-default" href="https://seculomanaus.com.br/portal/prova_gabarito/avaliacao_online/?prova=<?= base64_encode($row['CD_PROVA']) ?>&aluno=<?= $token ?>">
                                            <i class="fa fa-print"></i> PROVA
                                        </a>
