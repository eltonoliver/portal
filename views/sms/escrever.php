                ...
                <div class="row">
                    <form action="<?= SCL_RAIZ ?>mensagem/enviar" method="post" name="frmmensagem" id="form" class="form-inline" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-5">
                            ...
                            <a class="btn btn-danger" href="<?= SCL_RAIZ ?>/colegio/mensagem/"> <i class="icon-remove"></i> Cancelar </a>
...
<script type="text/javascript" src="<?= SCL_JS ?>jquery-2.0.3.min.js"></script> 
