        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <form class="form-bordered" enctype="multipart/form-data" method="post" action="<?=SCL_RAIZ?>site/noticias/cadastrar" id="commentForm">
                        <div class="form-group">
                            <label for="codigo">Código</label>
                            <input type="text" placeholder="Código" class="form-control" name="codigo" id="codigo" disabled="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input required name="dt_evento" type="text" class="form-control date-picker"  placeholder="Data do Evento" id="dt_evento" data-date-format="dd/mm/yyyy" style="width: 100px">
                        </div>
                        ...
                        <div class="form-group form-actions">
                            ...
                            <a class="btn btn-warning" href="<?= SCL_RAIZ ?>site/noticias">
