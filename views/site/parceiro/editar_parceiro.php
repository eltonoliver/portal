        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <form class="form-bordered" enctype="multipart/form-data" method="post" action="<?=SCL_RAIZ?>site/parceiros/editar_parceiro" id="commentForm">
                        <input type="hidden" name="cd_parceiro" value="<?= $dados[0]['CD_PARCEIRO'] ?>" >
                        <div class="form-group">
                            <label for="autor">Cadastrado por:</label>
                            <input type="text" placeholder="Autor" class="form-control" name="autor" id="autor" disabled="" value="<?= $dados[0]['NM_USUARIO'] ?>">
                            <input type="hidden" name="autor" value="<?=$this->session->userdata('SCL_SSS_USU_CODIGO')?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="nome">Nome</label>
                            <input type="text" placeholder="Nome" class="form-control" name="nome" id="nome" value="<?= $dados[0]['NOME'] ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="descricao" id="descricao"><?= $dados[0]['DESCRICAO'] ?></textarea>
                        </div>                    

                        <div class="form-group">
                            <label for="banner">Banner</label> <span class="text-danger">Só alterar caso queiara trocar o banner</span>
                        ...
                        <div class="form-group">
                            <label for="logo">Logo</label><span class="text-danger">Só alterar caso queira trocar a logo</span>
                        ...
                        <div class="form-group form-actions">
                            ...
                            <a class="btn btn-danger" href="<?= SCL_RAIZ ?>site/parceiros/">
