        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-warning">
                <div class="panel-heading">
                    Dados da tela de Atividades Extras
                </div>
                <div class="panel-body">
                    <form class="form-bordered" enctype="multipart/form-data" method="post" action="<?=SCL_RAIZ?>site/atividade/index" id="commentForm">
                        <input type="hidden" name="acao" value="1">
                        <div class="form-group">
                            <label for="descricao">Descricao</label>
                            <textarea required="" type="text" class="form-control" name="descricao" id="descricao" aria-required="true"><?=$atividade[0]['DESCRICAO']?></textarea>
                        </div>                    
