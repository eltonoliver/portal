...
$(function(){
    ...
    function txtFiltrar() {
        $("#tblFiltro").html('<?= LOAD ?>');
        $.post("<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/prova/grdProva') ?>", {
            filtro: 0,
    ...
    <div class="row projects">
        <div class="hpanel hgreen">
            <div class="panel-footer">
                <div class="row">
                <div class="col-sm-7">
                    <a class="btn btn-info" href="<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/prova/frmNovaProva') ?>"><i class="fa fa-plus"></i> Adicionar</a>
                </div>
                <div class="col-sm-5">
                    Num. Prova:
