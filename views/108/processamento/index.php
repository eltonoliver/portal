...
$(function(){
    ...
    function txtFiltrar() {
        $("#tblFiltro").html('<?= LOAD ?>');
        $.post("<?= base_url(''.$this->session->userdata('SGP_SISTEMA').'/processamento/grdProva') ?>", {
            filtro: 0,
            ...
            <div class="panel-footer">
                ...
                <div class="col-sm-7">
                        <span class="input-group-btn">
                            <button href="<?=base_url(''.$this->session->userdata('SGP_SISTEMA').'/processamento/mdlImportar')?>" data-toggle="frmModal" type="button" id="" class="btn btn-labeled btn-primary2">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="input-group btn-group">                        
                        <input placeholder="Ex: 2015000000" class="form-control  input-group-addon input-sm" type="text" name="avalNumProva" id="avalNumProva" />
                        <span class="input-group-btn">
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn-toggle btn btn-labeled btn-warning2 btn-sm" data-element="#BuscaAvancada">
...
<? } ?>
                    ...
                    <div class="form-group"><br>
                        <select name="FTTipo" id="FTTipo" class="form-control m-b input-sm">
...
<? } ?>
                    ...
                    <div class="form-group"><br>
                        <select name="FTCurso" id="FTCurso" class="form-control m-b input-sm" style="width:150px">
    ...
    <? }
                    ...
                    <div class="form-group"><br>
                        <select name="FTSerie" id="FTSerie" class="form-control m-b input-sm" style="width:120px">
                            <option value="">SÉRIE</option>
                        </select>
                    </div> 
                    <div class="form-group"><br>
                        <select name="FTBimestre" id="FTBimestre" class="form-control m-b input-sm" >
                    ...
                    <div class="form-group"><br>
                        <select name="FTTipoNota" id="FTTipoNota" class="form-control m-b input-sm" >
